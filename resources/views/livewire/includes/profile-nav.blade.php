<div class="flex justify-center lg:justify-start px-6 mt-6 overflow-x-auto scrollbar-hide">
    <nav class="flex space-x-6 text-gray-600 text-sm font-medium border-b w-full">
      ...
      <button @click="tab = 'contact'" :class="tab === 'photos' ? 'pb-2 border-b-2 border-blue-600 text-blue-600' : 'pb-2 hover:text-blue-600 hover:border-b-2 hover:border-blue-600'">Contact me</button>
